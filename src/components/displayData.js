      ...
      <>
        <div className="flex flex-row relative z-20 xl:h-[300px]">
          <div className="bg-[#1E1E27] rounded-[5px] w-full h-full p-5 gap-6">
            <div className="grid w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-12 min-w-full min-h-full w-full h-full">
        ...
        <div className={`bg-[#1E1E27] ${!playerData ? 'skeleton' : ''} rounded-[5px] relative z-20  w-full sm:w-1/2 h-[350px] p-5 gap-6`}>
